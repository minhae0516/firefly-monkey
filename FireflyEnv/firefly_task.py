...
def dynamics(x, a, dt, box, pro_gains, pro_noise_stds, action_vel_weight, action_ang_weight ):
    ...
    # for monkey data
    a_v = action_vel_weight * a[0]  # action for velocity
    a_w = action_ang_weight * a[1]  # action for angular velocity
...
class Model(nn.Module):
    ...
    def forward(self, x, a):
        ...
        next_x = dynamics(x, a, self.dt, self.box, self.pro_gains, self.pro_noise_stds, self.action_vel_weight, self.action_ang_weight)
        pos = next_x.view(-1)[:2]
